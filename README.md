Quick little arduino program to read from PPM-capable RC-receiver, and control two brushed DC-motors on h-bridge + some other widgets, with skid-steering algorithm and stuff.
